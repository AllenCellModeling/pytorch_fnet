...
class Net(torch.nn.Module):
    def __init__(self,
        ...
        self.feature_select = torch.nn.Conv3d(self.in_channels, select_channels, kernel_size=1)
        self.feature_bn = torch.nn.BatchNorm3d(select_channels)
        self.net_recurse = _Net_recurse(n_in_channels=select_channels, n_out_channels=self.mult_chan, depth=self.depth)
